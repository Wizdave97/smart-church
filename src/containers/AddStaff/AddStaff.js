...
class AddStaff extends Component {
  ...
  onSubmit = (references,hardSetState,e)=>{
    ...
    if (valid){
      ...
      if(this.state.updateBranch) permissions.push(3)
      if(this.state.updateStaff) permissions.push(5)
      if(this.state.updateReport) permissions.push(7)
      if(this.state.createStaff) permissions.push(4)
      if(this.state.createBranch) permissions.push(2)
      if(this.state.viewStaffs) permissions.push(10)
      if(this.state.viewBranches) permissions.push(9)
      if(this.state.viewReports) permissions.push(8)
      if(this.state.addReport) permissions.push(6)
